...
int main()
{
    ...
    fprintf(gnuplot, "set title 'Cascade PID'\n");
	...
	fprintf(gnuplot, "plot '-' using 1:2 with lines title 'Current Measured value', '-' using 1:2 with lines title 'Setpoint'\n");
